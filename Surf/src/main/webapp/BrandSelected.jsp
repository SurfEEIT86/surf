	...
	<div id="wrapper">
	    ...
	    <div id="page-wrapper">
            <div class="container-fluid">      
				...
				<div class="col-lg-12">
		                <h1 class="page-header"><a href="/Surf/ProductTypesServlet.do?type=${typeno}">${typename}</a> - ${brandname} 			               
                 ...
                 <div class="row">	
		         	<c:forEach var="products" items="${products}">
					 	...
					 	<div class="col-md-3 portfolio-item">
							...
							<img class="img-portfolio img-responsive" src="<c:url value="${products.pic1}" />">
							</a>
