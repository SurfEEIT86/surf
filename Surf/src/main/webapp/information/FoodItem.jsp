...
<body>
	...
	<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
		<button type="button">聚浪-資訊-美食</button>
		<h3>花蓮衝浪相關資訊-美食</h3>
		<div class="container">
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="#">第一麵</a>
			</div>
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-md-9">
				...
				<div class="thumbnail">
					<img class="img-responsive" src="img/portfolio-15.jpg" alt="">
				...
				<div class="well">
					...
					<div class="text-right">
						<a class="btn btn-success">發表評論</a>
					</div>
					...
					<div class="row">
						<div class="col-md-12">
							<span class="glyphicon glyphicon-star"></span> <span
								...
								class="glyphicon glyphicon-star"></span> <span
								class="glyphicon glyphicon-star"></span> <span
								class="glyphicon glyphicon-star-empty"></span>小強<span
					...
					<div class="row">
						<div class="col-md-12">
							<span class="glyphicon glyphicon-star"></span> <span
								...
								class="glyphicon glyphicon-star"></span> <span
								class="glyphicon glyphicon-star"></span> <span
								class="glyphicon glyphicon-star-empty"></span>姚明<span
					...
					<div class="row">
						<div class="col-md-12">
							<span class="glyphicon glyphicon-star"></span> <span
								...
								class="glyphicon glyphicon-star"></span> <span
								class="glyphicon glyphicon-star"></span> <span
								class="glyphicon glyphicon-star-empty"></span>杰倫 <span
