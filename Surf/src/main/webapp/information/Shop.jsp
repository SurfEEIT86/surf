                        ...
                        <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="item active">
                                    <img class="slide-image" src="img/portfolio-6.jpg" alt="">
                                </div>
                                <div class="item">
                                    <img class="slide-image" src="img/portfolio-7.jpg" alt="">
                                </div>
                                <div class="item">
                                    <img class="slide-image" src="img/portfolio-8.jpg" alt="">
                                </div>
                            </div>
